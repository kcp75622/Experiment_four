...
{	
	// Return from the function if the specificed duty_cycle is greater than
	// or equal to the given period. The duty cycle can't exceed 99%
	...
	// Set the ACTCMPAD field (Bits 7 to 6) to 0x03 in the PWM3GENA register
